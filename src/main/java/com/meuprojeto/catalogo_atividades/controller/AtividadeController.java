...
public class AtividadeController {
    ...
    // Redireciona a raiz para a página pública
    @GetMapping("/")
    public String redirecionarParaPaginaPublica() {
        return "redirect:/atividades/publica";
    }

    // Página pública de atividades (sem login)
    @GetMapping("/atividades/publica")
    public String paginaInicialPublica(
        ...
        return "atividades-publicas";
    }

    // Formulário de nova atividade (restrito a usuários logados)
    ...
    // Lista de atividades (restrita a usuários logados)
